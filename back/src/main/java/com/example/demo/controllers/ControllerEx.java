...
public class ControllerEx {
	...
	public void init() {
		...
		mobile.add(new Mobile(4, "iPhone 11 Pro", "Apple","lorem ipsum dolor sit amet consectetur", "black", 900, "IPhone_11.png", "7.5 inch IPS", "A14 Bionic", 2));
		mobile.add(new Mobile(5, "iPhone 12", "Apple","lorem ipsum dolor sit amet consectetur", "white", 850, "IPhone_12.png", "4.7 inch IPS", "A14 Bionic", 4));
		mobile.add(new Mobile(6, "Huawei nova 8i", "Huawei","lorem ipsum dolor sit amet consectetur", "black", 550, "Huawei_8.png", "6.57 inch IPS", "Snapdragon 778G", 8));
		mobile.add(new Mobile(7, "Huawei nova 9", "Huawei","lorem ipsum dolor sit amet consectetur", "black", 689, "Huawei_9.png", "6.57 inch IPS", "Snapdragon 778G fusion", 8));
